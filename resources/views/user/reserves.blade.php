...
<div class="container mt-5 pt-5 mb-5">
    <div class="d-flex justify-content-center row">
        <div class="col-md-10">
            ...
            <div class="row p-2 bg-white border rounded my-2">
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                    ...
                    <div class="d-flex flex-column mt-4">
                        <a href="/userid/reservas/id" class="btn btn-primary btn-sm" onclick="" type="button">Detalhes</a>
                        <button class="btn btn-danger btn-sm mt-2" type="button">Anular Reserva</button>
                    </div>
                </div>
            </div>
            <!-- Reserve Payed -->
            <div class="row p-2 bg-white border rounded my-2">
                <div class="col-md-3 mt-1">
                    <img class="img-fluid img-responsive rounded product-image" src="/bus_two.jpg">
                </div>
                <div class="col-md-6 mt-1">
                    <h5>Nome da Carrinha</h5>
                    <div class="d-flex flex-row">
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                    ...
                    <div class="d-flex flex-column mt-4">
                        ...
                        <button class="btn btn-danger btn-sm mt-2" type="button">Cancelar Reserva</button>
                    </div>
                </div>
            </div>
        </div>
